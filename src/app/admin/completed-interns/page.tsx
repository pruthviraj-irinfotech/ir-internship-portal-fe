...
export default function AdminCompletedInternsPage() {
    ...
    const fetchInterns = useCallback(async () => {
        ...
        setIsLoading(true);
        try {
            const data = await api.getInternsByStatus(token, 'Completed', searchTerm);
            setInterns(data);
        } catch (error: any) {
                ...
                <CardHeader>
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <CardDescription>View interns who have completed their programs.</CardDescription>
                        </div>
                                        ...
                                        <TableRow key={intern.id}>
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex justify-end gap-2">
                                                    <Button variant="outline" size="icon" asChild title="View Application">
                                                        <Link href={`/admin/completed-interns/${intern.id}`}>
